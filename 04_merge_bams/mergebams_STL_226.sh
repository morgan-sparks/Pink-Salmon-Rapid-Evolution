...
#SBATCH --job-name=mergebams_STL_226
#SBATCH -A standby
#SBATCH -t 4:00:00
#SBATCH -N 1
#SBATCH -n 64
...
I=$ADDRG/STL_226_run1_Ogor1.0_addedRG.bam \
I=$ADDRG/STL_226_run2_Ogor1.0_addedRG.bam \
SORT_ORDER=coordinate \
O=$MERGED/STL_226_Ogor1.0_merged.bam

samtools flagstat -@ 126 -O tsv $MERGED/STL_226_Ogor1.0_merged.bam > $MERGED/merged_flagstat/STL_226_rgroups_flagstat_out.txt
