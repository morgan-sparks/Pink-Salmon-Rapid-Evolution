...
#SBATCH --job-name=mergebams_STL_021
#SBATCH -A standby
#SBATCH -t 4:00:00
#SBATCH -N 1
#SBATCH -n 64
...
I=$ADDRG/STL_021_run1_Ogor1.0_addedRG.bam \
I=$ADDRG/STL_021_run2_Ogor1.0_addedRG.bam \
SORT_ORDER=coordinate \
O=$MERGED/STL_021_Ogor1.0_merged.bam

samtools flagstat -@ 126 -O tsv $MERGED/STL_021_Ogor1.0_merged.bam > $MERGED/merged_flagstat/STL_021_rgroups_flagstat_out.txt
