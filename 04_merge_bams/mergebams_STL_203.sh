...
#SBATCH --job-name=mergebams_STL_203
#SBATCH -A standby
#SBATCH -t 4:00:00
#SBATCH -N 1
#SBATCH -n 64
...
I=$ADDRG/STL_203_run1_Ogor1.0_addedRG.bam \
I=$ADDRG/STL_203_run2_Ogor1.0_addedRG.bam \
SORT_ORDER=coordinate \
O=$MERGED/STL_203_Ogor1.0_merged.bam

samtools flagstat -@ 126 -O tsv $MERGED/STL_203_Ogor1.0_merged.bam > $MERGED/merged_flagstat/STL_203_rgroups_flagstat_out.txt
