...
#SBATCH --job-name=mergebams_LAO_206
#SBATCH -A standby
#SBATCH -t 4:00:00
#SBATCH -N 1
#SBATCH -n 64
...
I=$ADDRG/LAO_206_run1_Ogor1.0_addedRG.bam \
I=$ADDRG/LAO_206_run2_Ogor1.0_addedRG.bam \
SORT_ORDER=coordinate \
O=$MERGED/LAO_206_Ogor1.0_merged.bam

samtools flagstat -@ 126 -O tsv $MERGED/LAO_206_Ogor1.0_merged.bam > $MERGED/merged_flagstat/LAO_206_rgroups_flagstat_out.txt
