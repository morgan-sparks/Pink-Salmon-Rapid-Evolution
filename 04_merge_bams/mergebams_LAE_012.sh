...
#SBATCH --job-name=mergebams_LAE_012
#SBATCH -A standby
#SBATCH -t 4:00:00
#SBATCH -N 1
#SBATCH -n 64
...
I=$ADDRG/LAE_012_run1_Ogor1.0_addedRG.bam \
I=$ADDRG/LAE_012_run2_Ogor1.0_addedRG.bam \
SORT_ORDER=coordinate \
O=$MERGED/LAE_012_Ogor1.0_merged.bam

samtools flagstat -@ 126 -O tsv $MERGED/LAE_012_Ogor1.0_merged.bam > $MERGED/merged_flagstat/LAE_012_rgroups_flagstat_out.txt
