...
#SBATCH --job-name=addreadgroups_LAE_082_run2
#SBATCH -A standby
#SBATCH -t 4:00:00
#SBATCH -N 1
#SBATCH -n 20
...
I=$ALIGNED/LAE_082_run2_Ogor1.0_aligned.bam \
O=$RGADD/LAE_082_run2_Ogor1.0_addedRG.bam \
SORT_ORDER=coordinate RGID=group1 RGLB=lib1 RGPL=illumina RGSM=LAE_082 RGPU=run2
