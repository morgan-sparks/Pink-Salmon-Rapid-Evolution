...
#SBATCH --job-name=addreadgroups_LAE_042_run2
#SBATCH -A standby
#SBATCH -t 4:00:00
#SBATCH -N 1
#SBATCH -n 20
...
I=$ALIGNED/LAE_042_run2_Ogor1.0_aligned.bam \
O=$RGADD/LAE_042_run2_Ogor1.0_addedRG.bam \
SORT_ORDER=coordinate RGID=group1 RGLB=lib1 RGPL=illumina RGSM=LAE_042 RGPU=run2
