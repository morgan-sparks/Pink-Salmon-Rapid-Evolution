...
#SBATCH --job-name=addreadgroups_STL_028_run2
#SBATCH -A standby
#SBATCH -t 4:00:00
#SBATCH -N 1
#SBATCH -n 20
...
I=$ALIGNED/STL_028_run2_Ogor1.0_aligned.bam \
O=$RGADD/STL_028_run2_Ogor1.0_addedRG.bam \
SORT_ORDER=coordinate RGID=group1 RGLB=lib1 RGPL=illumina RGSM=STL_028 RGPU=run2
