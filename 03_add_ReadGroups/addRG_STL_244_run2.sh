...
#SBATCH --job-name=addreadgroups_STL_244_run2
#SBATCH -A standby
#SBATCH -t 4:00:00
#SBATCH -N 1
#SBATCH -n 20
...
I=$ALIGNED/STL_244_run2_Ogor1.0_aligned.bam \
O=$RGADD/STL_244_run2_Ogor1.0_addedRG.bam \
SORT_ORDER=coordinate RGID=group1 RGLB=lib1 RGPL=illumina RGSM=STL_244 RGPU=run2
