...
#SBATCH --job-name=addreadgroups_STL_308_run1
#SBATCH -A standby
#SBATCH -t 4:00:00
#SBATCH -N 1
#SBATCH -n 20
...
I=$ALIGNED/STL_308_run1_Ogor1.0_aligned.bam \
O=$RGADD/STL_308_run1_Ogor1.0_addedRG.bam \
SORT_ORDER=coordinate RGID=group1 RGLB=lib1 RGPL=illumina RGSM=STL_308 RGPU=run1
