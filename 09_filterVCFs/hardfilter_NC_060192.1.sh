...
#SBATCH --job-name=hardfilter_NC_060192.1
#SBATCH -A beagle
#SBATCH -t 24:00:00
#SBATCH -N 1
#SBATCH -n 10
...
-V $CALLSNPS/allVariants/NC_060192.1.even.vcf.gz \
-select-type SNP \
-O $CALLSNPS/SNPsOnly/NC_060192.1_snps.vcf.gz 
...
-V $CALLSNPS/SNPsOnly/NC_060192.1_snps.vcf.gz \
...
-O $FILTERED/NC_060192.1_even_GATKfilter_snps.vcf.gz
