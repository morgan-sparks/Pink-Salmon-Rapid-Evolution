...
#SBATCH --job-name=hardfilter_CM029871.1
#SBATCH -A beagle
#SBATCH -t 24:00:00
#SBATCH -N 1
#SBATCH -n 10
...
-V $CALLSNPS/allVariants/CM029871.1.vcf.gz \
-select-type SNP \
-O $CALLSNPS/SNPsOnly/CM029871.1_snps.vcf.gz 
...
-V $CALLSNPS/SNPsOnly/CM029871.1_snps.vcf.gz \
...
-O $FILTERED/CM029871.1_hardfiltered_snps.vcf.gz
