...
#SBATCH --job-name=align_STL_153_run1
#SBATCH -A standby
#SBATCH -t 4:00:00
#SBATCH -N 1
#SBATCH -n 126
...
bwa mem -t 126 -M $PROJHOME/data/assemblies/Ogor_1.0/GCA_017355495.1_Ogor_1.0_genomic.fna $PROJHOME/data/seqs/trimmed_seqs/trimmed_fastq_v2/trimmed_paired_STL_153_R1_run1.fastq $PROJHOME/data/seqs/trimmed_seqs/trimmed_fastq_v2/trimmed_paired_STL_153_R2_run1.fastq > $PROJHOME/data/seqs/aligned_reads_Ogor1.0/02_batch_output/alignment_v2/STL_153_run1_Ogor1.0_aligned.bam
